...
function BitCard({ bit }) {
  ...
  return (
      <>
          <div className="bg-white rounded-lg overflow-hidden max-w-3xl my-4 mx-auto border border-black">
              <div className="flex p-4">
                  ...
                  <div>
                      <div className="flex items-center mb-2">
                          <p className="text-gray-700 font-bold text-sm mr-2">{bit.userDTO.userName}</p>
                          <span className="text-gray-500 text-xs">{bit.dateOfCreation}</span>
                      </div>
                      <div className="text-gray-800 font-normal text-sm mb-4">{bit.content}</div>
                      <div className="inline-block justify-between">
                          <button className="text-gray-500 font-medium text-sm border border-gray-500 rounded-lg px-4 py-2 hover:bg-gray-500 hover:text-white transition-all duration-300">
                              LIKE
                          </button>
                          {visiable ? (
                              <div>
                              ...
                              <button onClick={() => setVisiable(true)} className="text-gray-500 font-medium text-sm border border-gray-500 rounded-lg px-4 py-2 hover:bg-gray-500 hover:text-white transition-all duration-300">
                                  SHOW COMMENTS
                              </button>
                          )}
